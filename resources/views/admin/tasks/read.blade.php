        ...
        <div class="card-body">
            <table id="dataTable" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th>Muddati</th>
                    <th>Izoh</th>
                    <th>Topshiriqni ko`rgan bo`limlar</th>
                    <th>Fayllar</th>
                    <th>Amallar</th>
                </tr>
                </thead>
                            ...
                            @foreach($departments as $dp)
                                @foreach($datas as $d)
                                    @if($dp->id == $d->department_id)
                                        @if($d->status == 'read')
                                            <span class="btn bg-success m-1"> {{ $dp->name }}<br> <i class="fa-regular fa-clock"></i> <span class="">{{ $d->created_at ?? 'mavjud emas' }}</span></span>
