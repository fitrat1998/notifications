            ...
            <table id="dataTable" class="table table-bordered table-striped">
                ...
                @foreach($tasks as $task)
                    <tr>
                        ...
                        <td>
                            @php
                                $specificDate = \Carbon\Carbon::parse($task->deadline);
                                $today = \Carbon\Carbon::today(); // bugungi sana
                                $daysLeft = $specificDate->diffInDays($today, $specificDate);
                            @endphp

                            @if($daysLeft >= 0 && $daysLeft <= 3)
                                <span class="btn-warning">{{ $task->deadline }}</span>
                            @endif
                        </td>
                        ...
                        <td>
                         ...
                         <td>
                            @foreach($task->departments as $ds)
