                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="dataTable"
                            ...
                            @foreach($my_waiting_docs as $my_waiting_doc)
                                <tr id="">
                                    <td class="w-25">{{ $my_waiting_doc->id }}</td>
                                    <td class="w-25">{{ $my_waiting_doc->documenttype->name }}</td>
                                    <td class="w-25">

                                            <div class="summary">
                                                <p>{{ \Illuminate\Support\Str::limit(strip_tags($my_waiting_doc->comment), 100, '...') }}</p>
                                                <a href="#" class="read-more" data-content="{{ $my_waiting_doc->comment }}"
                                                   data-title="{{ ($my_waiting_doc->documenttype->name)  }}">To'liq o'qish</a>
                                            </div>
                                    ...
                                    <td>
                                        <div class="stepper-wrapper">
                                            @php
                                                $result = $my_waiting_doc->departments($my_waiting_doc->documenttype_id);
                                    ...
                                    <td>
                                        @if($my_waiting_doc->files->isNotEmpty())
                                            @foreach($my_waiting_doc->files as $f)
                                    ...
                                    <td><a href="{{ route('reciveddocuments.index') }}" class="btn-primary p-1">O`tish</a></td>
