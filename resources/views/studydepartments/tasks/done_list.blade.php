    ...
    <div class="card">
         <div class="card-body">
            <div class="card-header">
                ...
                <h3 class="card-title"><a href="{{ route('tasktables.index') }}" class="btn btn-primary">Barcha topshiriqlar <i
                ...
                <h3 class="card-title "><span class="m-2 text-primary">|</span> <a
                        href="{{ route('tasktables.waiting') }}" class="btn btn-warning">Muddat qo`yilmagan topshiriqlar <i
                            class="fa-solid fa-eye-slash"></i> </a></h3>
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($done as $send)
                    <tr id="datas_ids{{ $send->id }}">

                        <td>{{ $send->id }}</td>
                        <td>{{ $send->sendtask($send->task_id)}}</td>
                        ...
                        <td class="text-center w-25">
                            ...
                            <form action="{{ route('users.destroy',$send->id) }}" method="post">
                                ...
                                <div class="btn-category">
                                    @if($send->checkdone($send->task_id))
                                        @php
                                        ...
                                        <a href="{{ route('donetask.view', $send->task_id) }}"
                                           class="btn btn-primary btn-sm"><i class="fa-solid fa-eye"></i></a>
                                    @else
                                        <a href="{{ route('donetask.show', $send->task_id) }}"
