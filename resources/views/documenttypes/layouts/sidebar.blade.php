...
<nav class="mt-2">
    @canany(['permission.show', 'roles.show', 'user.show'])
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"
            ...
            <li class="nav-item {{ Request::is('permission*') || Request::is('role*') || Request::is('user*') || Request::is('departments*') || Request::is('documenttypes*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('permission*') || Request::is('role*') || Request::is('user*') || Request::is('departments*') || Request::is('documenttypes*') ? 'active' : '' }}">
